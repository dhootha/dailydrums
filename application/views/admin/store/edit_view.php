    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="well">
                ...
                <form id="frmAddPage" class="frmAddPage" action="<?php echo base_url('admin/store/update_store'); ?>" method="POST" enctype="multipart/form-data" >
                    <input type="hidden" name="store_id" value="<?=$store->store_id;?>" />
                    <input type="hidden" name="page_action" value="edit_store" />
                    <div id="home" >
                    <table>
                    		<tr>
                        	<td width="200">
	                        ...
	                        <select name="user_id" id="user_id" class="input-xlarge">
	                        	<?php foreach($user as $u){?>
	                        		<option <?=($u->id == $store->user_id)?"selected='selected'":'';?> value="<?=$u->id?>"><?=$u->display_name;?></option>
	                        	<?php } ?>
	                        </select>
                        ...
                        <tr>
                            ...
                            <td>
			                        <input type="text" name="store_name" id="store_name" class="input-xlarge" value="<?php echo set_value('store_name', $store->store_name); ?>">
		                        <span class="required"><?php echo form_error('store_name');?></span>
		                        <br>
	                        </td>
                         </tr>
                        ...
                        <tr>
                            ...
                            <td>
		                        <input type="text" name="address_line1" id="address_line1" class="input-xlarge" value="<?php echo set_value('address_line1', $store->address1); ?>">
                        ...
                        <tr>
                            ...
                            <td>
		                        <input type="text" name="address_line2" id="address_line2" class="input-xlarge" value="<?php echo set_value('address_line2', $store->address2); ?>">
                        ...
                        <tr>
                            ...
                            <td>
		                        <input type="text" name="street" id="street" class="input-xlarge" value="<?php echo set_value('street', $store->street); ?>">
                            ...
                            <td>
		                        <select name="city" id="city" class="input-xlarge">
		                        	...
		                        	<?php foreach($city as $c){?>
		                        		<option value="<?=$c->loc_id?>"  <?=($store->city == $c->loc_id)?"selected='selected'":set_select('city', '');?> ><?=$c->city;?></option>
		                        	<?php } ?>
		                        </select>
                        ...
                        <tr>
                            ...
                            <td>
		                        <input type="text" name="state" id="state" class="input-xlarge" value="<?php echo set_value('state', $store->state); ?>">
                        ...
                        <input type="hidden" id="pre_zip" name="pre_zip" value="<?=$store->zip;?>">
                       ...
                       <tr>
                            ...
                            <td>
                        <input type="text" name="phone" id="phone" class="input-xlarge" value="<?php echo set_value('phone', $store->phone); ?>">
                        ...
                        <tr>
                            ...
                            <td>
                        <input type="text" name="website" id="website" class="input-xlarge" value="<?php echo set_value('website', $store->website); ?>">
                        ...
                        <tr>
                            ...
                            <td>
	                           <img src="<?= base_url().'uploads/store_images/thumb/'.$store->logo;?>" height="200" width="300">
                        ...
                        <tr>
                            ...
                            <td>
                        <input type="text" name="tag_words" id="tag_words" class="input-xlarge" value="<?php echo set_value('tag_words', $store->tag_words); ?>">
			...
			$('#city').change(function() {  
							...
							request = $.ajax({
							  ...
							  request.done(function(response) {
										...
										if(response){
											zip_data = "<option value='' selected='selected'>Select a zip</option>";
											for(r in response){
												var selected_area = '';
												if(pre_zip == response[r].loc_id)
