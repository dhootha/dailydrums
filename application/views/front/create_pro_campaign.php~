<script type="text/javascript" >
	...
	function checkCampaignData_test(campaign_status){
		...
		if($('#campaign_url').val() == ''){
			alert("Please provide campaign url.");
			$('#campaign_url').focus();
			return false;		
			}
		if($('#country').val() == ''){
    ...
    <div class="row-fluid">
      <div class="span9 main_content">
        ...
        <div class="contact_form campaign_form"> <!-- selectForm  -->
          ...
          <form name="deal_upload" id="deal_upload" action="<?=base_url('user/campaign_pro_upload');?>"  method="post"  enctype="multipart/form-data">
            ...
            <div class="block">
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <select name="store_name" id="store_name" class="creat_camp_select">
                    ...
                    <option value="<?=$store->store_id?>" <?php echo set_select('store_name', $store->store_id);?> >
                    <?=$store->store_name;?>
                    </option>
                    <?php } ?>
                  </select>
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <select name="category" id="category" class="creat_camp_select">
                    ...
                    <option value="<?=$category->category_id?>" <?php echo set_select('category', $category->category_id);?> >
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <input name="title" id="title" type="text" value="<?php echo set_value('title', ''); ?>" class="inputbox">
                </div>
                <span class="error_message" id="form_error_first_name">
                <?=form_error('title');?>
                &nbsp;</span>
              ...
              <div class="row-fluid">
                <div class="span2 form_label">Campaign under </div>
                <div class="span8">
                  <select name="campaign_under" id="campaign_under" class="creat_camp_select">
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <textarea class="textarea" name="description" id="description" rows="6" cols="5"><?php echo set_value('description', ''); ?></textarea>
                </div>
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <div class="row-fluid">
                    ...
                    <div class="span4">
                      <input type="text" readonly="readonly" name="duration_from" id="duration_from"  value="<?php echo set_value('duration_from', ''); ?>" class="inputbox inputbox1" >
                    </div>
                    <div class="span2 form_label">To</div>
                    <div class="span4">
                      <input type="text" readonly="readonly" name="duration_to" id="duration_to" value="<?php echo set_value('duration_to', ''); ?>" class="inputbox inputbox1">
                    </div>
                    <span class="error_message" id="form_error_first_name">
            ...
            <div class="block">
              ...
              <div class="row-fluid">
                <div class="span2 form_label">Listing Image</div>
                  ...
                  <div class="selectForm">
                    <div class="floatleft w75p">
                      <!-- <div class="floatleft checkbox_text">
                        <input type="checkbox" name="use_logo" id="use_logo" value="use">
              ...
              <div class="row-fluid">
                <div class="span2 form_label">Campaign URL</div>
                <div class="span8">
                  <input name="campaign_url" id="campaign_url" type="text" value="<?php echo set_value('campaign_url', ''); ?>" class="inputbox">
                </div>
                <span class="error_message" id="form_error_first_name">
                <?=form_error('campaign_url');?>
                &nbsp;</span>
                <div class="clr"></div>
              </div>
             <!--  <div class="row-fluid">
            ...
            <div class="block">
              ...
              <div class="selectForm">
                    <p style="overflow:auto; padding:5px 10px 20px;">
			              <span style="float:right;">
	                        <input type="checkbox" name="print_opt" id="print_opt" style="float:left;" value="print">
	                        <span style="padding:5px 5px 0; float:left;">Print option &nbsp;  &nbsp; | &nbsp;  &nbsp; </span>
	                        <a class="blue" style="float:right; margin:5px 0px 0;" onclick="get_location_of_store();" href="javascript:void(0);">Insert from My Store</a>
			              </span>
              			</p>
              </div>
              <div class="row-fluid">
                ...
                <div class="span8">
                  <select name="country" id="country" class="creat_camp_select">
                    ...
                    <option value="<?=$con->id?>" <?php echo set_select('country', $con->id);?> >
                    <?=$con->country_name;?>
                    </option>
                    <?php } ?>
                  </select>
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <input type="text" name="region" id="region" class="inputbox" value="<?php echo set_value('region', ''); ?>">
                </div>
                <span class="error_message" id="form_error_first_name">
                <?=form_error('region');?>
                &nbsp;</span>
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <select name="city" id="city" onchange="get_city_area();" class="creat_camp_select">
                    ...
                    <option value="<?=$c->loc_id?>" <?php echo set_select('city', $c->loc_id);?> >
                    <?=$c->city;?>
                    </option>
                    <?php } ?>
                  </select>
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <input type="text" name="address" id="address" class="inputbox" value="<?php echo set_value('address', ''); ?>" >
                </div>
                <span class="error_message" id="form_error_first_name">
                <?=form_error('address');?>
                &nbsp;</span>
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <input type="text" name="phone" id="phone" class="inputbox" value="<?php echo set_value('phone', ''); ?>">
                </div>
                <span class="error_message" id="form_error_first_name">
                <?=form_error('phone');?>
                &nbsp;</span>
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <input type="text" name="website_url" id="website_url" class="inputbox" value="<?php echo set_value('website_url', ''); ?>">
                </div>
                <span class="error_message" id="form_error_first_name">
