...
<!--Start Content-->
        <div class="container-fluid">
            <div class="main_container thanku_page">
            	
            	
                <div class="row-fluid">
                <div class="span9 main_content">
                	<div class="thanku_h2"><h2>Thank You for your registration<h2></div>
                	<div class="thanku_text"><?=(isset($success_msg) ? $success_msg : '');?></div>
                </div>
