...
<div class="content">
    ...
    <div class="header">
        <h1 class="page-title">
            <?php
            if (!isset($pageName))
                echo $pageName = 'Add Basic Campaign';
            else
                echo $pageName;
            ?>
        </h1>
    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            ...
            <div class="well">
                ...
                <form id="frmAddPage" class="frmAddPage" action="<?php echo base_url('admin/deals/add_deal'); ?>" method="POST" enctype="multipart/form-data" >
                    <input type="hidden" name="page_action" value="add_deal" />
                    <div id="home" >
                    <table>
                    		<tr>
                        	<td width="200">
                       ...
                       <!-- <input type="text" name="store_name" id="store_name" class="input-xlarge" value=""> -->
                        ...
                        <br>
                        <input type="checkbox" name="use_logo" id="use_logo" value="use" > Use logo
                        </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
                        <input type="file" name="img" id="img" class="input-xlarge">
                        <span class="required"><?php echo form_error('img');?></span>
                        <br>
                        </td>
                        </tr>
