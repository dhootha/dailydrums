...
<div class="content">
    ...
    <div class="header">
        <h1 class="page-title">
            <?php
            if (!isset($pageName))
                echo $pageName = 'Edit Basic Campaign';
            else
                echo $pageName;
            ?>
        </h1>
        ...
        <div class="row-fluid">
            ...
            <div class="well">
                ...
                <form id="frmAddPage" class="frmAddPage" action="<?php echo base_url('admin/deals/update_campaign'); ?>" method="POST" enctype="multipart/form-data" >
                    ...
                    <input type="hidden" name="deal_type" value="basic" />
                    ...
                    <table>
                       ...
                       <!-- <input type="text" name="store_name" id="store_name" class="input-xlarge" value=""> -->
                        ...
                        <br>
                        <input type="checkbox" name="use_logo" id="use_logo" value="use" <?=($deal->use_logo == '1')?"checked='checked'":'';?>> Use logo
                        </td>
                        </tr>
                        ...
                        <tr>
                            ...
                            <td>
		                        <img src="<?= base_url().'uploads/deal_images/thumb/'.$deal->business_image;?>" height="200" width="300">
