		...
		if(city != '')	{
				request = $.ajax({
				  ...
				  request.done(function(response) {
						...
						$('#city_area').html("<option value=''>Select a city first</option>");
					  }
			}
      ...
      <div class="span9 main_content">
       ...
       <!--  <?php /* if($this->session->flashdata('action_msg')){ ?>
        ...
        <div class="contact_form campaign_form"> <!-- selectForm  -->
          ...
          <form name="deal_upload" id="deal_upload" action="<?=base_url('user/campaign_basic_upload');?>"  method="post"  enctype="multipart/form-data">
