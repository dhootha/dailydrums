        ...
        <div class="row-fluid">
            <div class="well">
                <div class="btn-toolbar">
                    <button class="btn btn-primary" onclick="window.location.href = '<?php echo base_url('admin/plan/home'); ?>'">
                        <strong>&lt;&lt;</strong> Back To Listing
                    </button>
                    <div class="btn-group"></div>                    
                </div>
                <form id="frmAddPage" class="frmAddPage" action="<?php echo base_url('admin/plan/edit_plan/plan/id/'.$plan->id); ?>" method="POST" enctype="multipart/form-data" >
                    <input type="hidden" name="page_action" value="edit_plan" />
                    ...
                    <div id="home" class="tab-pane active">
                        ...
                        <input type="text" name="price" id="price" class="input-xlarge" value="<?php echo stripslashes($plan->price);?>">
                        ...
                        <input type="text" name="duration" id="duration" class="input-xlarge" value="<?php echo stripslashes($plan->duration);?>">
