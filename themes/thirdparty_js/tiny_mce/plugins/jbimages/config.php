...
$dirName = '';
	...
	$config['img_path'] = 'images/editor_img'; // Relative to domain name
	//$config['upload_path'] = $_SERVER['DOCUMENT_ROOT'] .'/dating/'. $config['img_path']; // Physical path. [Usually works fine like this]
	
	$config['upload_path'] =  $_SERVER['DOCUMENT_ROOT'] .$dirName. $config['img_path']; // Physical path. [Usually works fine like this]
