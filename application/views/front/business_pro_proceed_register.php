...
<!--Start Content-->
        <div class="container-fluid">
            <div class="main_container">
            	<div class="main_head">
	            	<h2 class="title p_top50 floatleft">Bussiness Pro</h2>
                                				...
                                				if(!empty($plans))
                                					{
                                						foreach($plans as $plan){
                                							?>
					                                    <div class="rows">
					                                        <div class="span4"><input type="radio" name="plan" value="<?=$plan->id;?>" > <?=$plan->duration;?> Months</div>
					                                        <div class="span1">$<?=$plan->price;?></div>
                    	...
                    	<div class="service_term">
                            ...
                            <div class="content">                            
                                <ul class="bullet3">
                                    ...
                                    <li>Basic posting + Rich HTML page Display</li>
                          ...
                          <ul class="bullet4">
                            ...
                            <li><a class="blue" href="pricing-new2.html">Sample Posting</a></li>
                              ...
                              <!--<p><a class="blue_btn1" href="MyAccount-Bus-Basic.html">Business Basic</a></p>-->
                            </div>
                      </div>
                    </div>
                    <div class="clr"></div>
