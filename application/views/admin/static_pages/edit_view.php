    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="well">
                ...
                <form id="frmAddPage" class="frmAddPage" action="<?php echo base_url('admin/static_pages/edit_page/page/id/'.$page->page_id); ?>" method="POST" enctype="multipart/form-data" >
                    ...
                    <div id="home" class="tab-pane active">
                        ...
                        <input type="text" name="page_title" id="page_title" class="input-xlarge" value="<?php echo stripslashes($page->page_title);?>">
