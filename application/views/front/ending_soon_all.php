...
$(document).ready( function(){
	//alert("go");
	$("div[id^='endsoon_li#']").each(function(index){
...
function set_time_for_end(id){
						...
						//var target_date = parseInt(new Date(exp_dt+' 11:59:59 pm').getTime()); //Aug 15, 2019 // 86400 sec is adding 1 day extra for the days upto 11:59 pm
												
						//alert("exp_dt : "+exp_dt+" target_date : "+target_date);
...
<!-- ----------- Page content ---------- -->
       ...
       <div class="span9 main_content image_content_view">     
       					...
       					<div class="top_head">
                        <h2 class="title red floatleft">ENDING SOON</h2>
               ...
               <div class="list1 row-fluid">
                        <ul>
                            ...
                            <li class="span4" style="margin-left:0 !important;">
                            	<div class="block" id="endsoon_li#<?=$deals->id;?>" style="height:310px !important;">
                            		<input type="hidden" id="endsoon_expire_<?=$deals->id;?>" value="<?=strtotime(implode('-',array_reverse(explode('-',$deals->duration_to))).' 11:59:59 pm')*1000;?>" />
             							<div class="img">
                                	<!--<div class="img_hover">
											...
											<div class="row-fluid">
						                     	<div class="range_time">
						                             <div class="span3 align-center">
						                             	<div class="info1">
						                                     <span id="days_<?=$deals->id;?>" class="font_type1 font18">05</span><br>
						                                     <span>DAYS</span>
						                                 </div>
						                             </div>
						                             <div class="span3 align-center">
						                             	<div class="info1">
						                                     ...
						                                     <span id="hours_<?=$deals->id;?>" class="font_type1 font18">05</span><br>
						                                     <span>HRS</span>
						                                 </div>
						                             </div>
						                             <div class="span3 align-center">
						                             	<div class="info1">
						                                     <span class="colan">:</span>
						                                     <span id="minutes_<?=$deals->id;?>" class="font_type1 font18">05</span><br>
						                                     <span>MNTS</span>
						                                 </div>
						                             </div>
						                             <div class="span3 align-center">
						                             	<div class="info1">
						                                     <span class="colan">:</span>
						                                     <span id="seconds_<?=$deals->id;?>" class="font_type1 font18">05</span><br>
						                                     <span>SECS</span>
						                                 </div>
						                             </div>
						                             <div class="clr"></div>
