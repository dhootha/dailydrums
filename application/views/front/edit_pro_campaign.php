    ...
    <div class="row-fluid">
      <div class="span9 main_content">
        <h2 class="title">Edit Campaign  
        	...
        	<?php // echo "<pre>"; print_r($deal_details); exit; ?>	
        <div class="contact_form campaign_form"> <!-- selectForm  -->
       
          <form name="deal_upload" id="deal_upload" action="<?=base_url('user/campaign_pro_update');?>"  method="post"  enctype="multipart/form-data">
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <select name="campaign_under" id="campaign_under" class="creat_camp_select">
				      		<option value="1"  <?php if($deal_details->campaign_under == '1') echo "selected=selected"; echo set_select('campaign_under', '1');?> >In Stores</option>
				      		<option value="2"  <?php if($deal_details->campaign_under == '2') echo "selected=selected"; echo set_select('campaign_under', '2');?>>Neighborhood</option>
				      		<option value="3"  <?php if($deal_details->campaign_under == '3') echo "selected=selected"; echo set_select('campaign_under', '3');?>>Online</option>
				      </select>
                </div>
                <span class="error_message" id="form_error_first_name">
            ...
            <div class="block">
              ...
              <div class="row-fluid">
                ...
                <div class="span8">
                  <input name="campaign_url" id="campaign_url" type="text" value="<?php echo set_value('campaign_url', $deal_details->campaign_url); ?>" class="inputbox">
                </div>
                <span class="error_message" id="form_error_first_name">
              ...
              <div class="selectForm">
                    <p style="overflow:auto; padding:5px 10px 20px;">
			              <span style="float:right;">
	                        <input type="checkbox" name="print_opt" id="print_opt" style="float:left;" value="print" <?=($deal_details->print_opt == '1')?"checked='checked'":'';?>>
