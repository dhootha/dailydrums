            ...
            <div class="well">
                ...
                <form id="frmAddPage" class="frmAddPage" action="<?php echo base_url('admin/category/edit_category/category/id/'.$category->category_id); ?>" method="POST" enctype="multipart/form-data" >
                    ...
                    <div id="home" class="tab-pane active">
                        ...
                        <input type="text" name="category_name"  onkeyup="make_slug();" id="category_name" class="input-xlarge" value="<?php echo stripslashes($category->category_name);?>">
                        ...
                        <input type="text" name="category_slug" id="category_slug" class="input-xlarge" value="<?php echo stripslashes($category->category_slug);?>" readonly="true">
                        
                        <p>&nbsp;</p>
                        <label>
                        	<img src="<?=base_url($this->config->item('category_image')).'/'.$category->category_logo;?>" alt="" >
                        </label>
                        <label>
                            <span class="required">*</span> 
                            Category Logo: &nbsp;&nbsp;
