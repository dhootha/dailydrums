    ...
    <div class="container-fluid">
        ...
        <div class="row-fluid">
            <div class="well">
                ...
                <form id="frmAddPage" class="frmAddPage" action="<?php echo base_url('admin/plan/add_page'); ?>" method="POST" enctype="multipart/form-data" >
                    ...
                    <div id="home" class="tab-pane active">
                        ...
                        <input type="text" name="price" id="price" class="input-xlarge" value="">
                        ...
                        <input type="text" name="duration" id="duration" class="input-xlarge" value="">
