        ...
        <div class="row-fluid">
            <div class="well">
                ...
                <form id="frmAddPage" class="frmAddPage" action="<?php echo base_url('admin/user/register_business_user'); ?>" method="POST" enctype="multipart/form-data" >
                    <input type="hidden" name="page_action" value="add_pro_user" />
                    <div id="home" class="tab-pane active">

					<label>
                            <span class="required">*</span> 
                            User Plan: &nbsp;&nbsp;
                            <span class="required"><?php echo form_error('register_plan');?></span>
                        </label>
					<select name="register_plan" id="register_plan">
						<option value="" <?php echo set_select('register_plan', '', TRUE); ?>>Select a plan</option>
						<?php foreach($plan_list as $plan){?>
							<option value="<?=$plan->id?>"  <?php echo set_select('register_plan', $plan->id); ?> ><?=$plan->price." for ".$plan->duration." month(s)";?></option>
						<?php } ?>
					</select>                        
                        <p>&nbsp;</p>
