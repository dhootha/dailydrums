        ...
        <div class="row-fluid">
            <div class="well">
                <div class="btn-toolbar">
                    <button class="btn btn-primary" onclick="window.location.href = '<?php echo base_url('admin/static_pages/home'); ?>'">
                        <strong>&lt;&lt;</strong> Back To Listing
                    </button>
                    <div class="btn-group"></div>                    
                </div>
                <form id="frmAddPage" class="frmAddPage" action="<?php echo base_url('admin/static_pages/add_page'); ?>" method="POST" enctype="multipart/form-data" >
                    ...
                    <div id="home" class="tab-pane active">
                        ...
                        <input type="text" name="page_title" id="page_title" class="input-xlarge" value="">
                        ...
                        <textarea class="input-xlarge" name="page_content" id="page_content" rows="3"></textarea>
