...
function subscribe(){
   ...
   $.ajax({
        type: "POST",
        url: '<?php echo base_url('welcome/suscribeStore');?>',
        data: 'status='+status+'&store_id='+deal_id+'&action_on='+action_on,
        success: function(data) {
        	
        		var msg = "<strong>You have unsubscribed the store successfully.</strong>";
...
<!-- ----------- Page content ---------- -->
       ...
       <div class="span9 main_content image_content_view">         
                <div class="main_head">
                    	<h2 class="title floatleft">My Subscriptions</h2>
               ...
               <div class="list1 row-fluid">
                        <ul>
                            <?php
                            if(isset($my_subscription) && $my_subscription!=false){
                           
                            foreach($my_subscription as $deals){ ?>
                            
                            <li class="span4" id="subscribeDeal_<?php echo $deals->store_id;?>">
                                ...
                                <div class="img">
                                    ...
                                    <div class="img_hover">
                                    	<span class="btn1"><a href="#" onclick="dialogBox(<?php echo $deals->store_id;?>,'un')" class="black_btn1">Unsubscribe</a></span>
                                    </div>

                                    <img src="<?= base_url().'uploads/store_images/'.$deals->logo;?>" alt="" class="img_245main">
                                </div>
                                <h3><a href="#"><?php echo $deals->store_name;?><span class="font24">&#8594;</span></a></h3>
											<!-- <//?php echo site_url('welcome/dealDetails/'.$deals->store_id);?> -->                                
                            ...
                            <?php }}else{ ?>
                                ...
                                <li class="blue"><strong>No Stores Found.</strong></li>
